...
import com.example.roomdb.databinding.FragmentAddNoteBinding
...
class AddNoteFragment : Fragment(R.layout.fragment_add_note), MenuProvider {
    ...
    private fun saveNote(view: View){
        ...
        if (noteTitle.isNotEmpty()){
            ...
            Toast.makeText(addNoteView.context, "Enter not title", Toast.LENGTH_SHORT).show()
        }
